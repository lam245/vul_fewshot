...
def filter_datasets_by_matching_vulnerability_types(sven_data, big_vul_df, sven_cwe_ids=None):
    ...
    # Set of ignored CWE IDs as integers
    full_ignore_cwes = [121, 122, 123, 124, 126, 127, 128, 131, 135, 14, 170, 188, 194, 195, 196, 242, 243, 244, 364, 401, 415, 463, 464, 466, 467, 468, 469, 479, 482, 483, 558, 560, 562, 676, 690, 762, 781, 782, 785, 806, 839, 843]
    ignored_cwe_ids = set(full_ignore_cwes)
    logger.info(f"Ignored for these CWE IDs: {ignored_cwe_ids}")
